...
| **[Documentation & Skill Keeper](file:///C:/Users/Asus/Downloads/Platform AI Solutions/.agent/skills/Doc_Keeper/SKILL.md)** | *Cuando el usuario diga 'actualiza la documentación', 'refactoriza esta skill', o después de cambios grandes en arquitectura.* | Analiza el código y actualiza la documentación (docs/) y las Skills (.agent/skills/) para mantener la coherencia. |
