        ...
        <>
                ...
                <div className="relative">
                    <button
                        ...
                        className={`flex items-center gap-3 pl-3 pr-4 py-2 rounded-full border transition-all duration-300 group
                            ${isOpen
                                ? 'bg-black/60 border-indigo-500/50 shadow-[0_0_15px_rgba(99,102,241,0.3)]'
                                : 'bg-black/40 backdrop-blur-md border-white/10 hover:border-white/20 hover:bg-black/50'
                            }`}
                    >
                        {/* Avatar */}
                        <div className="w-9 h-9 rounded-full bg-gradient-to-tr from-indigo-500 via-purple-500 to-pink-500 p-[1.5px] shadow-lg">
                    ...
                    {isOpen && (
                        <>
                            ...
                            <div className="absolute top-full right-0 mt-3 w-64 bg-[#09090b]/95 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl z-50 overflow-hidden animate-in fade-in slide-in-from-top-2 origin-top-right">
            ...
            */}
            <header className="lg:hidden fixed top-0 left-0 right-0 h-16 bg-[#09090b]/90 backdrop-blur-md border-b border-white/5 z-50 flex items-center justify-between px-4">
                ...
                <div className="text-sm font-bold tracking-widest text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-purple-400 uppercase">
                    NEXUS AI
                </div>
